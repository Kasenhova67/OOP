...
namespace testt
{
    ...
    public class Document : ISubject
    {
        ...
        private void DisplayPreviewMode()
        {
            ...
            {
                // Для режима Preview используем GetText(), который должен возвращать текст без символов форматирования
        ...
        {
            var command = new InsertTextCommand(this, position, text, format); // Добавляем параметр format
            command.Execute();
        ...
        public class InsertTextCommand : ICommand
        {
            ...
            public void Execute()
            {
                ...
                // Применяем форматирование в соответствии с параметром
        ...
        /*public class FormatRangeCommand : ICommand
        {
            private readonly Document _document;
            private readonly int _start;
            private readonly int _end;
            ...
            public FormatRangeCommand(Document document, int start, int end, string formatType)
            {
                _document = document;
                _start = start;
                _end = end;
        ...
        /* public void Undo()
         {
             ...
             {
                 var mod = _modifications[i];
                 _document.GetContent().RemoveRange(mod.Index, mod.NewComponents.Count);
                 _document.GetContent().Insert(mod.Index, mod.OriginalComponent);
             }
         }
         ...
         private class TextModification
         {
             public int Index { get; set; }
             public TextComponent OriginalComponent { get; set; }
             public List<TextComponent> NewComponents { get; set; }
         }
     }
...
*/
        ...
        /*private class FormatTextCommand : ICommand
        {
            private readonly Document _document;
            private readonly int _start;
            private readonly int _end;
