    ...
    public class DocumentEditorApp
    {
            ...
            while (!back)
            {
                ...
                if (int.TryParse(Console.ReadLine(), out int editChoice))
                {
                    switch (editChoice)
                    {
                        ...
                        case 7: _documentManager.CurrentDocument.Undo(); break;
                        case 8: _documentManager.CurrentDocument.Redo(); break;
            ...
            while (!exit)
            {
                ...
                if (int.TryParse(Console.ReadLine(), out int mainChoice))
                {
                    switch (mainChoice)
                    {
                        ...
                        case 6: exit = true; _exitRequested = true; break;
                        default: ShowError("Invalid choice"); break;
                    }
                }
                else
        ...
        private void CopyText()
        {
            ...
            if (int.TryParse(Console.ReadLine(), out int startPos))
            {
                ...
                {
                    _documentManager.CurrentDocument.Copy(startPos, length);
        ...
        private void CutText()
        {
            ...
            if (int.TryParse(Console.ReadLine(), out int startPos))
            {
                ...
                if (int.TryParse(Console.ReadLine(), out int length))
                {
                    _documentManager.CurrentDocument.Cut(startPos, length);
        ...
        private void PasteText()
        {
            ...
            {
                _documentManager.CurrentDocument.Paste(pos);
